...
void drawSub(int, int);
void drawBottle(int, int);
void drawFish(int, int);


void eraseSub(int, int);
void eraseBottle(int, int);
void eraseFish(int, int);


void drawCoral(int, int, unsigned short);
void drawReef(int, int);
...
void drawSub(int x, int y) {
    ...
    drawRect(x+2, y+11, 1, 2, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+3, y+10, 1, 3, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+4, y+8, 3, 7, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+7, y+7, 2, 9, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+9, y+5, 14, 13, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+23, y+6, 2, 11, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+25, y+7, 1, 9, ((28) | (25)<<5 | (9)<<10));

    drawRect(x+9, y+10, 3, 3, ((9) | (25)<<5 | (30)<<10));
    drawRect(x+15, y+10, 3, 3, ((9) | (25)<<5 | (30)<<10));
    drawRect(x+21, y+10, 3, 3, ((9) | (25)<<5 | (30)<<10));

    setPixel(x, y+8, ((23) | (23)<<5 | (23)<<10));
    setPixel(x, y+15, ((23) | (23)<<5 | (23)<<10));
    drawRect(x, y+9, 2, 2, ((23) | (23)<<5 | (23)<<10));
    drawRect(x, y+13, 2, 2, ((23) | (23)<<5 | (23)<<10));

    drawRect(x+14, y+4, 7, 1, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+18, y+2, 2, 2, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+18, y, 3, 2, ((28) | (25)<<5 | (9)<<10));
    drawRect(x+21, y, 1, 2, ((9) | (25)<<5 | (30)<<10));

    drawRect(x+26, y+7, 1, 9, ((28) | (11)<<5 | (8)<<10));
    drawRect(x+27, y+8, 2, 7, ((28) | (11)<<5 | (8)<<10));
    drawRect(x+29, y+9, 1, 5, ((28) | (11)<<5 | (8)<<10));
}


void drawBottle(int x, int y) {
    drawRect(x+2, y, 2, 2, ((28) | (11)<<5 | (8)<<10));
    drawRect(x+1, y+2, 4, 1, ((23) | (27)<<5 | (28)<<10));
    drawRect(x, y+3, 6, 12, ((23) | (27)<<5 | (28)<<10));
    drawRect(x, y+6, 6, 3, ((28) | (11)<<5 | (8)<<10));
}


void drawFish(int x, int y) {

    drawRect(x, y+3, 1, 2, ((21) | (9)<<5 | (29)<<10));
    drawRect(x+1, y+2, 1, 4, ((21) | (9)<<5 | (29)<<10));
    drawRect(x+2, y+1, 2, 6, ((21) | (9)<<5 | (29)<<10));
    drawRect(x+4, y, 3, 8, ((21) | (9)<<5 | (29)<<10));
    drawRect(x+7, y+1, 2, 6, ((21) | (9)<<5 | (29)<<10));
    drawRect(x+9, y+2, 1, 4, ((21) | (9)<<5 | (29)<<10));
    drawRect(x+10, y+1, 1, 6, ((21) | (9)<<5 | (29)<<10));
    drawRect(x+11, y, 1, 8, ((21) | (9)<<5 | (29)<<10));

    drawRect(x+2, y+3, 2, 2, ((31) | (31)<<5 | (31)<<10));
    setPixel(x+2, y+3, 0);
}
...
void eraseSub(int x, int y) {
    ...
    drawRect(x+2, y+11, 1, 2, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+3, y+10, 1, 3, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+4, y+8, 3, 7, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+7, y+7, 2, 9, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+9, y+5, 14, 13, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+23, y+6, 2, 11, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+25, y+7, 1, 9, ((12) | (20)<<5 | (29)<<10));


    setPixel(x, y+8, ((12) | (20)<<5 | (29)<<10));
    setPixel(x, y+15, ((12) | (20)<<5 | (29)<<10));
    drawRect(x, y+9, 2, 2, ((12) | (20)<<5 | (29)<<10));
    drawRect(x, y+13, 2, 2, ((12) | (20)<<5 | (29)<<10));

    drawRect(x+14, y+4, 7, 1, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+18, y+2, 2, 2, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+18, y, 3, 2, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+21, y, 1, 2, ((12) | (20)<<5 | (29)<<10));

    drawRect(x+26, y+7, 1, 9, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+27, y+8, 2, 7, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+29, y+9, 1, 5, ((12) | (20)<<5 | (29)<<10));
}


void eraseBottle(int x, int y) {
    drawRect(x+2, y, 2, 2, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+1, y+2, 4, 1, ((12) | (20)<<5 | (29)<<10));
    drawRect(x, y+3, 6, 12, ((12) | (20)<<5 | (29)<<10));
    drawRect(x, y+6, 6, 3, ((12) | (20)<<5 | (29)<<10));
}

void eraseFish(int x, int y) {
    drawRect(x, y+3, 1, 2, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+1, y+2, 1, 4, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+2, y+1, 2, 6, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+4, y, 3, 8, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+7, y+1, 2, 6, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+9, y+2, 1, 4, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+10, y+1, 1, 6, ((12) | (20)<<5 | (29)<<10));
    drawRect(x+11, y, 1, 8, ((12) | (20)<<5 | (29)<<10));
...
void drawReef(int x, int y) {
    drawRect(x, y, 11, 25, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+11, y+2, 6, 23, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+14, y+3, 3, 22, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+17, y+5, 2, 20, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+19, y+6, 3, 19, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+22, y+7, 2, 18, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+24, y+8, 2, 17, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+26, y+10, 1, 15, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+27, y+11, 3, 14, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+30, y+13, 2, 12, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+32, y+14, 2, 11, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+34, y+16, 1, 9, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+32, y+18, 2, 7, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+34, y+18, 3, 7, ((24) | (8)<<5 | (26)<<10));
    drawRect(x+37, y+20, 2, 5, ((24) | (8)<<5 | (26)<<10));
}

void drawStartScreen() {
    fillScreen(((12) | (20)<<5 | (29)<<10));
    drawRect(0, 130, 240, 30, ((27) | (26)<<5 | (17)<<10));
    drawReef(0, 105);
    drawCoral(210, 107, ((25) | (13)<<5 | (7)<<10));
    drawString(96, 55, "SUBSAVER", ((31) | (31)<<5 | (31)<<10));
    drawString(60, 138, "press select to play", ((31) | (31)<<5 | (31)<<10));
    drawSub(105, 70);
}

void drawGameScreen() {
    fillScreen(((12) | (20)<<5 | (29)<<10));
    drawRect(0, 145, 240, 20, ((27) | (26)<<5 | (17)<<10));
}

void drawPauseScreen() {
    fillScreen(((12) | (20)<<5 | (29)<<10));
    drawCoral(15, 130, ((25) | (13)<<5 | (7)<<10));
    drawCoral(205, 125, ((25) | (13)<<5 | (7)<<10));
    drawRect(0, 140, 240, 20, ((27) | (26)<<5 | (17)<<10));
    drawString(102, 80, "PAUSED", ((31) | (31)<<5 | (31)<<10));
}

void drawLoseScreen() {
    fillScreen(((12) | (20)<<5 | (29)<<10));
    drawCoral(15, 130, ((25) | (32)<<5 | (16)<<10));
    drawCoral(205, 125, ((25) | (32)<<5 | (16)<<10));
    drawRect(0, 140, 240, 20, ((27) | (26)<<5 | (17)<<10));
    drawString(87, 80, "You Lost :(", ((31) | (31)<<5 | (31)<<10));
    drawBottle(117, 95);
}

void drawWinScreen() {
    fillScreen(((12) | (20)<<5 | (29)<<10));
    drawCoral(15, 130, ((25) | (31)<<5 | (16)<<10));
    drawCoral(205, 125, ((25) | (31)<<5 | (16)<<10));
    drawRect(0, 140, 240, 20, ((27) | (26)<<5 | (17)<<10));
    drawString(100, 80, "You Won!", ((31) | (31)<<5 | (31)<<10));
    drawFish(114,95);
}
